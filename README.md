...
Mixi TurboDecks is a strictly typed library of high-performance drop-in plugins for the Mixi web-based DJ platform. These decks function as standalone modular instruments or atmospheric audio generators designed to perfectly integrate within the Mixi master mixer and transport architecture.
